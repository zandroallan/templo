    @extends('layouts.app')
        ...
        @section('content')
            ...
            <h2 class="content-heading">Listado de Roles de Usuario</h2>
            <div class="block block-themed">
                <div class="block-header bg-amethyst-dark">
                    <h3 class="block-title">Roles de Usuarios</h3>
                    <div class="block-options space-x-1">
                        @can('rol-create')
                        <a class="btn btn-sm btn-alt-secondary" href="{{ route('roles.create') }}">
