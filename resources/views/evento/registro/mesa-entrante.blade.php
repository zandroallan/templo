...
<html lang="en">
    ...
    <body>
                                        ...
                                        <!-- Header -->
                                            <div class="text-center">
                                                ...
                                                <h1 class="h4 mb-0">
                                                    ...
                                                    Registro del <span class="text-success">Equipo de Transición Entrante</span>
                                                </h1>
                                                <hr />
                                            ...
                                            <div class="_primario">
                                                <form name="frm-registro" id="frm-registro">
                                                    <div class="row">
                                                        <h2 class="content-heading border-bottom mb-4 pb-2">Organismo público asignado</h2>
        ...
        <script type="text/javascript">
            ...
            function validateFormOrganismo()
             {
                let vstatus=true;
                let _valueDataForm=document.getElementById('_id_dependencia').value;
                if (  _valueDataForm == '' ) {
                    $('#_id_dependencia').addClass("is-invalid");
                    if (vstatus) {
                        $('#_id_dependencia').focus();
                    }
                    vstatus = false;
                }
                return vstatus;
                ...
                Swal.fire({
                    ...
                    if (result.value) { 
                        ...
                        if ( validateForm('frm-registro') ) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: vuri + '/evento/registro/entrante/store',
                                dataType: "JSON",
