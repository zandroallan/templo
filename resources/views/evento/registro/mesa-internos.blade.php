                                    ...
                                    <div class="col-md-8 col-lg-6 col-xl-7 py-4 px-4 px-lg-5">
                                        <!-- Header -->
                                            <div class="text-center">
                                                ...
                                                <h1 class="h4 mb-0">
                                                    Mesas de Trabajo del Procedimiento de Transición<br /> Registro de <span class="text-success">Contralores y Comisarios</span>
                                                </h1>
                                                <hr />
                                                ...
                                                <form name="frm-registro" id="frm-registro">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <input type="text" class="form-control form-control-alt" name="cargo" id="cargo" placeholder="Cargo">
                                                        </div>
                ...
                Swal.fire({
                    ...
                    if (result.value) { 
                        ...
                        if ( validateForm('frm-registro') ) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: vuri + '/evento/registro/internos/store',
                                dataType: "JSON",
