                                                ...
                                                <form name="frm-registro" id="frm-registro">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8 col-xl-8 mb-2">
                                                            <input type="text" class="form-control form-control-alt" name="nombre[]" id="nombre1" placeholder="Nombre Titular" required>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            <input type="text" class="form-control form-control-alt" name="correo[]" id="correo1" placeholder="Correo electrónico titular">
                                                        </div>

                                                        <h2 class="content-heading border-bottom mb-4 pb-2">Datos del enlace operativo</h2>

                                                        <div class="col-md-8 col-xl-8 mb-2">
                                                            <input type="text" class="form-control form-control-alt" name="nombre[]" id="nombre2" placeholder="Nombre Enlace" required>
                                                        </div>
                                                        <div class="col-md-4 col-xl-4 mb-2">
                                                        ...
                                                        <div class="col-md-4 col-xl-4 mb-2">
                                                            <input type="text" class="form-control form-control-alt" name="cargo[]" id="cargo2" placeholder="Cargo">
                                                        </div>
                                                        <div class="col-md-8 mb-2">
                                                            <input type="text" class="form-control form-control-alt" name="correo[]" id="correo2" placeholder="Correo Electrónico enlace">
                                                        </div>                                                                                                   
                                                    </div>
                                                </form> 
