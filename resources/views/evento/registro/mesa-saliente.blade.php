                                    ...
                                    <div class="col-md-8 col-lg-6 col-xl-7 py-4 px-4 px-lg-5">
                                        <!-- Header -->
                                            <div class="text-center">
                                                ...
                                                <h1 class="h4 mb-0">
                                                    Mesas de Trabajo del Procedimiento de Transición<br />
                                                    Registro de <span class="text-success">Funcionarios de los Organismos Públicos</span>
                                                </h1>
                                                <hr />
                                                <p class="fw-medium mb-3" style="text-align: justify;">
                                                    Con la finalidad de llevar un control de los asistentes al evento, solicitamos de la manera más respetuosa requisitar los siguientes datos:
                                                </p>
                                                <p class="fw-medium mb-3" style="text-align: center;">
                                                    <b>
                                                        Nota: Al correo electrónico proporcionado se hará llegar una liga para descarga del código QR que será solicitado para acceder al evento.<br />
                                            ...
                                            <div class="_primario">
                                                <form name="frm-registro" id="frm-registro">
                                                    <div class="row">
                                                        ...
                                                        <h2 class="content-heading border-bottom mb-4 pb-2">Datos asistente</h2>
                                                        <div class="col-md-8 col-xl-8 mb-2">
                                                            <input type="hidden" name="saliente" id="saliente" value="1">
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <!-- <input type="text" class="form-control form-control-alt" name="cargo" id="cargo" placeholder="Cargo" required> -->
                                                            <select class="form-control form-control-alt" name="cargo" id="cargo">
                                                                <option value="">-- Seleccionar --</option>
                                                                <option value="Titular del Organismo Público">Titular del Organismo Público</option>
                                                                <option value="Unidad de Apoyo Administrativo/Enlace Operativo">Unidad de Apoyo Administrativo/Enlace Operativo</option>
                                                                <option value="Área de Recursos Humanos">Área de Recursos Humanos</option>
                                                                <option value="Área de Recursos Materiales">Área de Recursos Materiales</option>
                                                                <option value="Área de Recursos Financieros">Área de Recursos Financieros</option>
                ...
                Swal.fire({
                    ...
                    if (result.value) { 
                        ...
                        if ( validateForm('frm-registro') ) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: vuri + '/evento/registro/saliente/store',
                                dataType: "JSON",
