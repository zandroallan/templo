                                    ...
                                    <div class="col-md-8 col-lg-6 col-xl-7 py-4 px-4 px-lg-5">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="fw-medium mb-3" style="text-align: justify;">
                                                Con la finalidad de llevar un control de los funcionarios que asistirán al evento <b>Acto inaugural de las mesas de trabajo del procedimiento de transición</b>, solicitamos de la manera más respetuosa requisitar los siguientes datos:
                                            </p>
                                        </div>
                                        <hr/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-4 col-xl-4">
                                                <a class="block block-rounded block-link-pop h-100 mb-0" href="{{ url('registro/apertura/internos') }}">
                                                    <div class="block-content block-content-full text-center bg-flat">
                                                        <div class="item item-2x item-circle bg-white-10 py-3 my-3 mx-auto">
                                                            <span class="fa fa-building-user fa-2x text-white-75"></span>
                                                        </div>
                                                    </div>
                                                    <div class="block-content block-content-full text-center">
                                                        ...
                                                        <!-- <div class="fs-sm text-muted">Noviembre 4, 2024 a las 9:00 am.</div> -->
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-6 col-lg-4 col-xl-4">
                                                <a class="block block-rounded block-link-pop h-100 mb-0" href="{{ url('registro/apertura/entrante') }}">
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-4">
                                                <a class="block block-rounded block-link-pop h-100 mb-0" href="{{ url('registro/apertura/saliente') }}">
