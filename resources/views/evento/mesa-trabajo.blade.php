    @extends('layouts.app')
        ...
        @section('content')
            ...
            <h2 class="content-heading">Listado de evento mesas de trabajo</h2>
                        ...
                        <div class="block block-rounded block-transparent mb-0">
                            ...
                            <div class="block-content fs-sm">
                                ...
                                <form name="frm-registro" id="frm-registro">
                                    <input type="hidden" id="mesa_trabajo" name="mesa_trabajo" value="1">
                                    <div class="row">
        ...
        @section('js')
            ...
            <script src="{{ asset('public/views/eventos/mesa-trabajo.js') }}"></script>
